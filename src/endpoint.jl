...
`AbstractEndpoint`, `SingleEndpoint`, `ListEndpoint`, and `StreamEndpoint` based
on the supertype of the output form (a `Stream` output selects `StreamEndpoint`;
see the streaming manual).
